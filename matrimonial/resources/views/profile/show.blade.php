...
@section('content')
    ...
    <div class="profile-card" style="margin-bottom: 5%;">
        @php
        ...
        <!-- ================= PROFILE CARD ================= -->
        <div class="container profile-floating-card animate-fade-in">
            @if(session('success'))
                <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="info-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"><strong>Marital Status:</strong> {{ ucfirst($profile->marital_status) }}
                            </div>
