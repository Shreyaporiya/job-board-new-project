...
@php
    ...
    $oldLocation = old('preferences.location', $prefs['location'] ?? []);
    $oldLocation1=implode(', ', $oldLocation);
@endphp
        ...
        @can('changeActivation', $profile)
            <div class="mt-3">
                @if($profile->is_active)
                    <button class="btn btn-deactive" data-bs-toggle="modal" data-bs-target="#activationModal" data-action="deactivate">
                        Deactivate Profile
                    </button>
                @else
                    <button class="btn btn-active" data-bs-toggle="modal" data-bs-target="#activationModal" data-action="activate">
                        Activate Profile
                    </button>
                @endif
            </div>
                    ...
                    <div class="row">
                                ...
                                <select id="country" name="country" class="form-select">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}"
                                            {{ $oldCountry == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="preferences[location][]" class="form-select">
                                    <option value="India,Gujarat,Rajkot" {{ in_array('India,Gujarat,Rajkot',=== $oldLocation1) ? 'selected' : '' }}>India,Gujarat,Rajkot</option>
                                    <option value="India,Gujarat,Ahmedabad" {{ in_array('India,Gujarat,Ahmedabad',=== $oldLocation1) ? 'selected' : '' }}>India,Gujarat,Ahmedabad
                                    </option>
                                    <option value="India,Gujarat,Surat" {{ in_array('India,Gujarat,Surat',=== $oldLocation1) ? 'selected' : '' }}>India,Gujarat,Surat</option>
                                    <option value="India,Maharashtra,Mumbai" {{ in_array('India,Maharashtra,Mumbai',=== $oldLocation1) ? 'selected' : '' }}>India,Maharashtra,Mumbai
                                    </option>
                                    <option value="India,Maharashtra,Pune" {{ in_array('India,Maharashtra,Pune',=== $oldLocation1) ? 'selected' : '' }}>India,Maharashtra,Pune
                                    </option>
                                    <option value="India,Rajasthan,Jaipur" {{ in_array('India,Rajasthan,Jaipur'=== $oldLocation1) ? 'selected' : '' }}>India,Rajasthan,Jaipur</option>
                                    <option value="India,Rajasthan,Udaipur" {{ in_array('India,Rajasthan,Udaipur'=== $oldLocation1) ? 'selected' : '' }}>India,Rajasthan,Udaipur</option>
                                    <option value="India,Karnataka,Bengaluru" {{ in_array('India,Karnataka,Bengaluru'=== $oldLocation1) ? 'selected' : '' }}>India,Karnataka,Bengaluru</option>
                                    <option value="India,Karnataka,Mysuru" {{ in_array('India,Karnataka,Mysuru'=== $oldLocation1) ? 'selected' : '' }}>India,Karnataka,Mysuru</option>
                                    <option value="India,Tamil Nadu,Chennai" {{ in_array('India,Tamil Nadu,Chennai'=== $oldLocation1) ? 'selected' : '' }}>India,Tamil Nadu,Chennai</option>
                                    <option value="India,Tamil Nadu,Coimbatore" {{ in_array('India,Tamil Nadu,Coimbatore'=== $oldLocation1) ? 'selected' : '' }}>India,Tamil Nadu,Coimbatore</option>

                                    <!-- USA -->
                                    <option value="USA,California,Los Angeles" {{ in_array('USA,California,Los Angeles'=== $oldLocation1) ? 'selected' : '' }}>USA,California,Los Angeles</option>
                                    <option value="USA,California,San Francisco" {{ in_array('USA,California,San Francisco'=== $oldLocation1) ? 'selected' : '' }}>USA,California,San Francisco</option>
                                    <option value="USA,New York,New York City" {{ in_array('USA,New York,New York City'=== $oldLocation1) ? 'selected' : '' }}>USA,New York,New York City</option>
                                    <option value="USA,Texas,Houston" {{ in_array('USA,Texas,Houston'=== $oldLocation1) ? 'selected' : '' }}>USA,Texas,Houston</option>
                                    <option value="USA,Florida,Miami" {{ in_array('USA,Florida,Miami'=== $oldLocation1) ? 'selected' : '' }}>USA,Florida,Miami</option>

                                    <!-- UK -->
                                    <option value="UK,England,London" {{ in_array('UK,England,London'=== $oldLocation1) ? 'selected' : '' }}>UK,England,London</option>
                                    <option value="UK,Scotland,Edinburgh" {{ in_array('UK,Scotland,Edinburgh'=== $oldLocation1) ? 'selected' : '' }}>UK,Scotland,Edinburgh</option>
                                    <option value="UK,Wales,Cardiff" {{ in_array('UK,Wales,Cardiff'=== $oldLocation1) ? 'selected' : '' }}>UK,Wales,Cardiff</option>

                                    <!-- Canada -->
                                    <option value="Canada,Ontario,Toronto" {{ in_array('Canada,Ontario,Toronto'=== $oldLocation1) ? 'selected' : '' }}>Canada,Ontario,Toronto</option>
                                    <option value="Canada,British Columbia,Vancouver" {{ in_array('Canada,British Columbia,Vancouver'=== $oldLocation1) ? 'selected' : '' }}>Canada,British Columbia,Vancouver
                                    </option>
                                    <option value="Canada,Alberta,Calgary" {{ in_array('Canada,Alberta,Calgary'=== $oldLocation1) ? 'selected' : '' }}>Canada,Alberta,Calgary</option>

                                    <!-- Australia -->
                                    <option value="Australia,New South Wales,Sydney" {{ in_array('Australia,New South Wales,Sydney'=== $oldLocation1) ? 'selected' : '' }}>Australia,New South Wales,Sydney
                                    </option>
                                    <option value="Australia,Victoria,Melbourne" {{ in_array('Australia,Victoria,Melbourne'=== $oldLocation1) ? 'selected' : '' }}>Australia,Victoria,Melbourne</option>
                                    <option value="Australia,Queensland,Brisbane" {{ in_array('Australia,Queensland,Brisbane'=== $oldLocation1) ? 'selected' : '' }}>Australia,Queensland,Brisbane</option>

                                    <!-- Germany -->
                                    <option value="Germany,Bavaria,Munich" {{ in_array('Germany,Bavaria,Munich'=== $oldLocation1) ? 'selected' : '' }}>Germany,Bavaria,Munich</option>
                                    <option value="Germany,Berlin,Berlin" {{ in_array('Germany,Berlin,Berlin'=== $oldLocation1) ? 'selected' : '' }}>Germany,Berlin,Berlin</option>
                                    <option value="Germany,Hesse,Frankfurt" {{ in_array('Germany,Hesse,Frankfurt'=== $oldLocation1) ? 'selected' : '' }}>Germany,Hesse,Frankfurt</option>
                            </select>
                                ...
                                @foreach(['single','divorced','widow'] as $status)
                                    <label class="pref-chip shadow-sm" style="background:#f8f9fa; cursor:pointer;">
                                        <input type="checkbox"
                                               ...
                                               value="{{ $status }}"
                                               {{ in_array($status, $oldMarital) ? 'checked' : '' }}>
                            ...
                            <select id="skills" name="preferences[personality][]" multiple class="w-full"
                                ...
                                <option value="Family Oriented" {{ in_array('Family Oriented', old('preferences.personality', $oldPersonality)) ? 'selected' : '' }}>Family Oriented</option>
