    ...
    <div class="container" style="width:450px;">
        ...
        @if($upload)
            ...
            @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif', 'ico']))
                ...
                <!-- Hidden Upload Form -->
                <form id="changeImageForm" action="{{ route('upload.handle') }}" method="POST" enctype="multipart/form-data"
                    class="d-none">
                    @csrf
        ...
        @else
            ...
            <!-- Hidden Upload Form -->
            <form id="uploadImageForm" action="{{ route('upload.handle') }}" method="POST" enctype="multipart/form-data"
                class="d-none">
                @csrf
